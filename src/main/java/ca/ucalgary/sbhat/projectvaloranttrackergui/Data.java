...
public class Data {
    ...
    public HashMap<String, Player> getPlayerStats() {
        return usernames; // or playerStats, depending on where you store actual Player objects
    }
...
//    }
     ...
     */
    public void storeNewGame(String username, Maps map, String gameMode, boolean won, int kills, int deaths, int assists, Agents agent) {
