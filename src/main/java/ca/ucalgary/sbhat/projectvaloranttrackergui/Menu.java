...
import ca.ucalgary.sbhat.projectvaloranttrackergui.enums.*;
import ca.ucalgary.sbhat.projectvaloranttrackergui.util.Reader;
import ca.ucalgary.sbhat.projectvaloranttrackergui.util.colorsExtra;
...
public class Menu {
    ...
    public static HashMap<String, HashMap<String, Integer>> playerStats = new HashMap<String, HashMap<String, Integer>>();
    ...
    private static ca.ucalgary.sbhat.projectvaloranttrackergui.Data Data = new Data();
        ...
        while (true) {
            ...
            switch (menuOption) {
                ...
                case 17:
                    ...
                    break;
                case 18:
                    System.out.print("Enter the USERNAME to read data from: ");
                    ...
                    // Read data from the file associated with the username
                    String fileName = username + "_games.csv"; // Assuming the file is named after the username
...
//    }
    ...
    public static void menuCreateNewGame() {
        ...
        Data.storeNewGame(username, mapPlayed, gamemodePlayed.name(), gameWon, kills, deaths, assists, agentPlayed);
